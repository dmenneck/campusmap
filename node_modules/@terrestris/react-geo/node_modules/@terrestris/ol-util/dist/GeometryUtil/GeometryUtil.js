...
function () {
  ...
  _createClass(GeometryUtil, null, [{
    key: "splitByLine",
     ...
     */
    value: function splitByLine(polygon, line) {
      ...
      geometries.forEach(function (geometry) {
        ...
        var innerPolygon = (0, _polygonize["default"])((0, _helpers.featureCollection)(inners)); // make a lineString from the spliting line and the outer of the polygon
        ...
        allSplitedPolygons = [].concat(_toConsumableArray(features), _toConsumableArray(allSplitedPolygons));
      });
      ...
      geometries.forEach(function (geometry) {
        ...
        if (geomType.startsWith(GeometryUtil.MULTI_GEOM_PREFIX)) {
          ...
          switch (multiGeomPartType) {
            case 'Polygon':
              separatedGeometries.push.apply(separatedGeometries, _toConsumableArray(geometry.getPolygons()));
              break;

            case 'LineString':
              separatedGeometries.push.apply(separatedGeometries, _toConsumableArray(geometry.getLineStrings()));
              break;

            case 'Point':
              separatedGeometries.push.apply(separatedGeometries, _toConsumableArray(geometry.getPoints()));
              break;
    ...
    value: function union(polygons) {
      ...
      var unioned = _union2["default"].apply(void 0, _toConsumableArray(geoJsonsFeatures));
...
_defineProperty(GeometryUtil, "MULTI_GEOM_PREFIX", 'Multi');
