...
var _CircleMenuItem = require("./CircleMenuItem.js");
  ...
  describe('applyTransformation', function () {
    it('applies the transformation to the ref', function () {
      ...
      return new Promise(function (resolve) {
        ...
        expect(instance._ref.style.transform).toBe("rotate(".concat(rotationAngle, "deg) translate(").concat(radius, "px) rotate(-").concat(rotationAngle, "deg)"));
      });
    });
  });
});