...
function (_React$PureComponent) {
  _inherits(LayerTreeNode, _React$PureComponent);
  ...
  function LayerTreeNode(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(LayerTreeNode).call(this, props));
  }
  /**
   * The render function.
   *
  ...
  _createClass(LayerTreeNode, [{
    ...
    value: function render() {
      var _this$props = this.props,
          inResolutionRange = _this$props.inResolutionRange,
          children = _this$props.children,
          passThroughProps = _objectWithoutProperties(_this$props, ["inResolutionRange", "children"]);

      var isFolder = Array.isArray(children) && children.length > 0;
      var addClassName = (inResolutionRange ? 'within' : 'out-off') + '-range';
      addClassName += isFolder ? ' tree-folder' : ' tree-leaf';
      var finalClassname = "".concat(_constants.CSS_PREFIX, "layertree-node ").concat(addClassName);
...
}(_react["default"].PureComponent); // Otherwise rc-tree wouldn't recognize this component as TreeNode, see
// https://github.com/react-component/tree/blob/master/src/TreeNode.jsx#L543


_defineProperty(LayerTreeNode, "propTypes", {
  children: _propTypes["default"].array,
  inResolutionRange: _propTypes["default"].bool
  /**
   * The constructor.
   *
