...
describe('<LayerTree />', function () {
  ...
  describe('<LayerTreeNode> creation', function () {
    ...
    it('can handle nested `ol.layer.group`s', function () {
      var props = {
        layerGroup: layerGroup,
        map: map
      };
      ...
      var treeNodes = wrapper.find('LayerTreeNode');
      var groupNode = treeNodes.at(0);
      var subNode = groupNode.props().children[0];
    ...
    it('accepts a custom title renderer function', function () {
      var nodeTitleRenderer = function nodeTitleRenderer(layer) {
        ...
        }, layer.get('name')), _react["default"].createElement("span", {
    ...
    describe('#treeNodeFromLayer', function () {
      it('logs an error if called with an invisible layergroup', function () {
        var props = {
          layerGroup: layerGroup,
          map: map
        };
  ...
  describe('event handling', function () {
    it('sets checked state corresponding to layer.setVisible', function () {
      ...
      var treeNode = wrapper.find('LayerTreeNode').at(1);
  ...
  describe('#setLayerVisibility', function () {
    ...
    it('sets the visibility only for the children when called with a layerGroup', function () {
      var props = {
        layerGroup: layerGroup,
        map: map
      };
