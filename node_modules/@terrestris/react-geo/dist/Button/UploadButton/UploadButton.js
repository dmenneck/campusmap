...
function (_React$Component) {
  ...
  function UploadButton() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(UploadButton)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "className", "".concat(_constants.CSS_PREFIX, "uploadbutton"));
  ...
  _createClass(UploadButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          passThroughProps = _objectWithoutProperties(_this$props, ["className", "children", "onChange", "inputProps"]);

      var finalClassName = className ? "".concat(className, " ").concat(this.className) : this.className;

      var button = _react["default"].createElement(_SimpleButton["default"], passThroughProps);

      return _react["default"].createElement("div", {
        className: finalClassName
      }, children || button, _react["default"].createElement("input", _extends({
        type: "file",
        onChange: onChange
      }, inputProps)));
    }
...
_defineProperty(UploadButton, "propTypes", {
  /**
