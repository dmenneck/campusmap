...
describe('MapProvider', function () {
  ...
  function (_React$Component) {
    ...
    _createClass(MockComponent, [{
      ...
      value: function render() {
        return _react["default"].createElement("div", null, "Mockety-mock");
      }
    }]);
  ...
  describe('Basics', function () {
    ...
    it('provides a given map to its children (ol.Map)', function () {
      ...
      var wrapper = (0, _enzyme.mount)(_react["default"].createElement(_MapProvider["default"], {
        map: map
      }, " ", _react["default"].createElement(MappifiedMockComponent, null))); // resolve our promise, so this async behaviour is testable.
    ...
    it('provides a given map to its children (Promise)', function () {
      ...
      var wrapper = (0, _enzyme.mount)(_react["default"].createElement(_MapProvider["default"], {
        map: mapPromise
      }, " ", _react["default"].createElement(MappifiedMockComponent, null)));
      expect.assertions(2);
      return mapPromise.then(function () {
        var isReady = wrapper.state('ready');
        expect(isReady).toBe(true);
