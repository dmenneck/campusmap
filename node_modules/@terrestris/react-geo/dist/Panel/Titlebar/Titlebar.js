...
exports["default"] = exports.Titlebar = void 0;
...
function (_React$Component) {
  ...
  function Titlebar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "className", "".concat(_constants.CSS_PREFIX, "titlebar"));
  ...
  _createClass(Titlebar, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          passThroughProps = _objectWithoutProperties(_this$props, ["className", "tools", "children"]);

      var finalClassName = className ? "".concat(className, " ").concat(this.className) : this.className;
      return _react["default"].createElement("div", _extends({
        className: finalClassName
      }, passThroughProps), _react["default"].createElement("span", {
        className: "title"
      }, children), !(0, _isEmpty["default"])(tools) ? _react["default"].createElement("span", {
        className: "controls"
      }, tools) : null);
    }
  }]);
...
_defineProperty(Titlebar, "propTypes", {
  /**
   ...
   * @type {Array<object>}
   */
  tools: _propTypes["default"].arrayOf(_propTypes["default"].element)
  /**
   * The render function.
   */
